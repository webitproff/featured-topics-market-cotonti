 ...
 */
/**
 * featuredtopicsmarket.ajax.php - AJAX search for recommended topics in market.edit.tpl
 *
 * featuredtopicsmarket plugin for Cotonti 0.9.26, PHP 8.4+
 * Filename: featuredtopicsmarket.ajax.php
 *
 * Date: Jan 25Th, 2026
...
$max_select_itemslist_market_rft = (int)($cfg['plugin']['featuredtopicsmarket']['max_select_itemslist_market_rft'] ?? 50);
...
$rows = $db->query(
    "SELECT ft_id AS id, ft_title AS text
     ...
     LIMIT $max_select_itemslist_market_rft",
    $params
